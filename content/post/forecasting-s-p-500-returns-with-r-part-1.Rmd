...
# Load data
tickers <- readxl::read_xlsx("C:/Users/user/Desktop/invest-with-r/data/FRED Tickers.xlsx", sheet = 1, range = "A1:A300") %>%
      drop_na()	
	
# Load data	
data <- fread("C:/Users/user/Desktop/invest-with-r/data/Data from FRED.csv") %>% 	
      as_tibble() %>%	
