...
suppressPackageStartupMessages({
    ...
    # Time series
    library(tsibble) # for time series based on tidy principles
...
**Academic Findings**
Many leaders in the academic community have analyzed stock returns over longer time horizons and over wider groups of stocks (not just 500 of the largest) and found that generally, stock returns follow random walks (i.e., behave like white noise). 
