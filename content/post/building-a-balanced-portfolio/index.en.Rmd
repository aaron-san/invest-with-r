...
how it should be considered in the investment decision.

# Portfolio Volatility

Let's rank the portfolios in terms of return and volatility. For returns, a rank 
one will be assigned to the portfolio with the highest return. For volatility,
a rank of one will be assigned to the portfolio with the lowest standard deviation.
...
Of the 10 portfolios with the highest returns, all had relatively high volatility. 
...
of these high return portfolios. So, what should we have done?
...
How did the best Sharpe ratio (efficient) portfolios perform based on total 
returns?
