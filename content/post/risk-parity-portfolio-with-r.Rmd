...
# Risk Parity Portfolio vs. Markowitz Tangency Portfolio
 In this article we will compare the difference in two separate portfolio construction pathways, one using the risk parity portoflio approach and the other the Markowitz tangency portfolio approach.
 
The standard approach is the mean-variance optimization approach that produces a portfolio with the optimal risk-return ratio among a group of possible portfolios. One complaint of this approach is its tendency to lead to overconcentrated portfolios.

An alternative approach is the risk parity approach which produces a portfolio whose constituents contribute equally to the risk of the portfolio. 
